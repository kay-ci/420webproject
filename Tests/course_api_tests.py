...
class TestAPIElements(flask_unittest.ClientTestCase):
    ...
    def testC_dont_get_course(self, client):
        resp = client.get("/api/courses/?id=test")
    ...
    def testD_post_course(self, client):
        ...
        resp = client.post("/api/courses/", json = course1)
        self.assertEqual(resp.status_code, 201)
        resp = client.post("/api/courses/", json = course2)
        self.assertEqual(resp.status_code, 201)
    ...
    def testF_update_course(self, client):
        resp = client.get('/api/courses/1111111111')
        self.assertEqual(resp.status_code, 200) 
        course = resp.json
        ...
        resp = client.put("/api/courses/3333333333", json = course)
